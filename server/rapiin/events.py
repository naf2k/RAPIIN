...
CHANNEL_PREFIX = "rapiin:task-events:"
...
def _redis_client():
    ...
    try:
        ...
        return Redis.from_url(settings.rapiin_redis_url, decode_responses=True)
...
def _ensure_listener() -> None:
    ...
    threading.Thread(target=run, name="rapiin-sse-bridge", daemon=True).start()
